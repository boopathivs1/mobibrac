...
public class CreditCard extends ProjectWrappers {
	
	
	public CreditCard(AndroidDriver driver, ExtentTest test)
	{
		this.driver = driver;
		this.test = test;
	}

	public CreditCard verifyCreditCardPagebalance(String CreditCardno){
		
		String cardno=regvalue(CreditCardno);
