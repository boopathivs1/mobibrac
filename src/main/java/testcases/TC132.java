...
public class TC132 extends ProjectWrappers {
	@BeforeClass()
	public void setData() {
		testCaseName="TC132";
		testDescription="Pay transfer to Other bank(Existing Benef) via Credit card less than minimum amount";
		browserName="chrome";
	...
	public void login(String TestcaseName,String Devicename,String versionName,String udid,String portnumber,String username
			,String password,String selectBeneAccno,String fromAcc,String amount,String purpose,String Message,String Benetype,
